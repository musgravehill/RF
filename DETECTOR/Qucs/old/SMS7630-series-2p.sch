...
<Properties>
  <View=-244,-594,1437,598,0.683015,41,36>
  <Grid=10,10,1>
  <DataSet=SMS7630-series-2p.dat>
  <DataDisplay=SMS7630-series-2p.dpl>
  <OpenDisplay=1>
  <Script=SMS7630-series-2p.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Название>
  <FrameText1=Чертил:>
...
<Components>
  ...
  <GND * 1 -100 -190 0 0 0 0>
  <.DC DC1 1 450 -320 0 69 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
  ...
  <SPfile X2 1 0 -390 -26 -59 0 0 "C:/usr/seo-soft/!!HW-PROJECTS/RF/DETECTOR/Qucs/S2P/SERIES.s2p" 1 "rectangular" 0 "linear" 0 "open" 0 "2" 0>
  <.SP SP1 1 450 -200 0 69 0 0 "lin" 1 "5 GHz" 1 "6 GHz" 1 "50" 1 "no" 0 "1" 0 "2" 0 "no" 0 "no" 0>
</Components>
<Wires>

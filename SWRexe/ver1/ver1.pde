...
//correction
int[] vswr_shortPort = new int[4400];
int vswr_shortPort_min=0;
int vswr_shortPort_max=0;

//button
int btn_init_shortPort_x = 5;
int btn_init_shortPort_y = 5;
int btn_init_shortPort_w = 22;
int btn_init_shortPort_h = 22;
...
void setup() {   
  vswr_shortPort[33] = 198; 
  vswr_shortPort[34] = 220;
  vswr_shortPort_max = max(vswr_shortPort); 
  println(vswr_shortPort_max);
...
void draw() { 
  ...
  //btn
  rect(btn_init_shortPort_x, btn_init_shortPort_y, btn_init_shortPort_w, btn_init_shortPort_h);
  fill(255);
  
  if (mousePressed) {
    if (mouseX>btn_init_shortPort_x && mouseX <btn_init_shortPort_x+btn_init_shortPort_w && mouseY>btn_init_shortPort_y && mouseY <btn_init_shortPort_y+btn_init_shortPort_h) {
